...
(function(){        //Self-executing function.
	...
	var search = function(query){                                           //Declare and define the variable as a function.
		...
		if(results.length == 0){                                             //Conditional statement to check if the length of the results array is equal to 0.  **FIXED the conditional statement to equal to (==) instead of a definition equals (=).
            noMatch();                                                      //Invoke the noMatch function.  **FIXED the line to invoke the function
